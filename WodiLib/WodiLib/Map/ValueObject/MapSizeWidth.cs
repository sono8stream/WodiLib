...
namespace WodiLib.Map
{
    ...
    public readonly struct MapSizeWidth : IConvertibleInt, IEquatable<MapSizeWidth>
    {
        ...
        /// <summary>最小値</summary>
        public static readonly int MinValue = 20;
        ...
        /// コンストラクタ
        /// </summary>
        /// <param name="value">[Range(20, 9999)] マップサイズ横</param>
        /// <exception cref="ArgumentOutOfRangeException">numberが指定範囲外の場合</exception>
        public MapSizeWidth(int value)
        {
        ...
        public bool Equals(MapSizeWidth other)
        {
        ...
        /// <summary>
        /// int -> MapSizeWidth への暗黙的な型変換
        /// </summary>
        /// <param name="src">変換元</param>
        /// <returns>変換したインスタンス</returns>
        public static implicit operator MapSizeWidth(int src)
        {
            var result = new MapSizeWidth(src);
            return result;
        }

        /// <summary>
        /// MapSizeWidth -> int への暗黙的な型変換
        /// </summary>
        /// <param name="src">変換元</param>
        /// <returns>変換したインスタンス</returns>
        public static implicit operator int(MapSizeWidth src)
        {
            return src.Value;
        }
        ...
        public static bool operator ==(MapSizeWidth left, MapSizeWidth right)
        {
